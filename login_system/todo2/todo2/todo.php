...
include "config.php";if (isset($_POST['cari'])) {
  $cari=$_POST['cari'];
  $sql=" SELECT * FROM tbtodo_3 WHERE tugas LIKE '%$cari%'";
}else{
  $sql="SELECT * FROM tbtodo_3 LIMIT 0,5;";
}

if (isset($_GET['star'])) {
  $star= $_GET['star'];
  $sql="SELECT * FROM tbtodo_3 LIMIT $star,5;";
}

$hasil= mysqli_query($mysqli,$sql);
$sql2= "SELECT * FROM tbtodo_3";
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="todo2/aksi_tambah_todo.php">
